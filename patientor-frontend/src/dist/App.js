...
var PatientListPage_1 = require("./PatientListPage");
var App = function () {
    var _a = state_1.useStateValue(), dispatch = _a[1];
    react_1["default"].useEffect(function () {
        ...
        var fetchPatientList = function () { return __awaiter(void 0, void 0, void 0, function () {
            var patientListFromApi, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1["default"].get(constants_1.apiBaseUrl + "/patients")];
                    case 1:
                        patientListFromApi = (_a.sent()).data;
        ...
        react_1["default"].createElement(react_router_dom_1.BrowserRouter, null,
            react_1["default"].createElement(semantic_ui_react_1.Container, null,
                ...
                react_1["default"].createElement(react_router_dom_1.Switch, null,
                    react_1["default"].createElement(react_router_dom_1.Route, { path: '/', render: function () { return react_1["default"].createElement(PatientListPage_1["default"], null); } }))))));
};
exports["default"] = App;
